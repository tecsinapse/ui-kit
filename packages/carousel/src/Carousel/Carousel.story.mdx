...
import { AutoRotatingCarousel } from './AutoRotatingCarousel/AutoRotatingCarousel';
...
A Carousel is composed by Slides. The `AutoRotatingCarousel` and `Slide` components can receive the following props:
...
<Source id="packages-tecsinapse-carousel--single" />
...
<Source id="packages-tecsinapse-carousel--multiple" />
...
<Source id="packages-tecsinapse-carousel--mobile" />
