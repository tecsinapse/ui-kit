...
import { DatePicker, DateTimePicker, TimePicker, ColorPicker, PickersProvider } from '@tecsinapse/pickers';
import { DateTime } from 'luxon';
import { Typography } from '@material-ui/core';

<Meta
  title="@tecsinapse/pickers|Picker"
...
To view `Picker` component and it's props, check out [@tecsinapse/picker](https://github.com/tecsinapse/picker).
After importing `@tecsinapse/ui-kit` and `@tecsinapse/picker`, all you have to do is:

```
import { ThemeProvider } from '@tecsinapse/ui-kit';
import { DatePicker, PickersProvider } from '@tecsinapse/picker';
...
<Source id="tecsinapse-pickers-picker--date" />
...
<Source id="tecsinapse-pickers-picker--date-time" />
...
<Source id="tecsinapse-pickers-picker--custom-input" />
...
<Source id="tecsinapse-pickers-picker--week" />
...
<Source id="tecsinapse-pickers-picker--time" />
...
<Source id="tecsinapse-pickers-picker--color" />
