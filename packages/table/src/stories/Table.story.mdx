...
import { resolveData, handleRowClick } from '../Table/utils/tableFunctions';
import { Cells } from '../Table/Rows/Cells/Cells';
...
<Source id="packages-tecsinapse-table--simple" />
...
<Source id="packages-tecsinapse-table--actions" />
...
<Source id="packages-tecsinapse-table--actions-vertical" />
...
<Source id="packages-tecsinapse-table--advanced-filters" />
...
<Story name="Custom advanced filters" parameters={{ docs: { disable: true } }}>
  <Table
    ...
    rowId={row => row.code}
    toolbarOptions={countryOptions}
    onDrawerClose={() => console.log('Custom close callback')}
    pagination
    customAdvancedFilters={{
      applyFilters: () => console.log('Custom apply filters'),
      cleanFilters: () => console.log('Custom clean filters'),
...
<Source id="packages-tecsinapse-table--custom-advanced-filters" />
...
<Source id="packages-tecsinapse-table--custom-render" />
...
<Source id="packages-tecsinapse-table--custom-header" />
...
<Source id="packages-tecsinapse-table--custom-row" />
...
<Source id="packages-tecsinapse-table--custom-reusable-row" />
...
<Source id="packages-tecsinapse-table--header-exporter" />
...
<Source id="packages-tecsinapse-table--footer-exporter" />
...
<Source id="packages-tecsinapse-table--filtering" />
...
<Source id="packages-tecsinapse-table--pagination" />
...
<Source id="packages-tecsinapse-table--selection" />
...
<Source id="packages-tecsinapse-table--server-side" />
...
<Source id="packages-tecsinapse-table--sort" />
